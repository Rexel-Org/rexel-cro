      ...
      >
        ...
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
            <span className="inline-flex items-center rounded-full bg-violet-80 px-2 py-0.5 text-[10px] font-bold uppercase tracking-[0.08em] text-white">
              Panier simplifié
            </span>
          ...
          <div className="mt-2 flex items-center justify-end">
            <span className="inline-flex items-center gap-1 text-xs font-semibold text-violet-80 group-hover:underline">
